namespace Dapper.Common
{
    ...
    public interface IQueryable<T>
    {
        ...
        IQueryable<T> Page(int index, int count, out int total, bool condition = true);
        ...
        int Count(string columns = null, bool condition = true, int? timeout = null);

        Task<long> CountAsync(string columns = null, bool condition = true, int? timeout = null);

        int Count<TResult>(Expression<Func<T, TResult>> expression, bool condition = true, int? timeout = null);
    ...
    public interface IQueryable<T1, T2>
    {
        ...
        IQueryable<T1, T2> Page(int index, int count, out int total, bool condition = true);
    ...
    public interface IQueryable<T1, T2, T3>
    {
        ...
        IQueryable<T1, T2, T3> Join<E1, E2>(Expression<Func<E1, E2, bool>> expression, JoinType join = JoinType.Inner)
            where E1 : class
            where E2 : class;
        ...
        IQueryable<T1, T2, T3> Page(int index, int count, out int total, bool condition = true);
