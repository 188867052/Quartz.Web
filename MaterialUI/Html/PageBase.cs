namespace MaterialKit.Html
{
    ...
    public abstract class PageBase
    {
        ...
        protected IHtmlContent Header()
        {
            ...
            {
                TagHelper.SelfClosingTag(Tag.link, new TagAttributeList() { { Attr.Rel, "apple-touch-icon" }, { Attr.Sizes, "sizes" }, { "href", "/img/apple-icon.png" }, }),
                TagHelper.SelfClosingTag(Tag.link, new TagAttributeList() { { Attr.Rel, "icon" }, { Attr.Type, "image/png" }, { "href", "/img/favicon.png" }, }),
                ...
                TagHelper.Create(Tag.meta, new TagAttributeList { { "content", "width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" }, { "name", "viewport" }, }),
            };
