...
namespace MaterialUI.Entity
{
    ...
    {
        public MaterialKitContext()
        {
        }

        public MaterialKitContext(DbContextOptions<MaterialKitContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=.;App=EntityFrameworkCore;Initial Catalog=MaterialKit;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QrtzBlobTriggers>(entity =>
            {
                ...
                entity.HasOne(d => d.QrtzTriggers)
                    ...
                    .HasConstraintName("FK__QRTZ_BLOB_TRIGGE__55F4C372");
            });
            ...
            modelBuilder.Entity<QrtzCronTriggers>(entity =>
            {
                ...
                entity.HasOne(d => d.QrtzTriggers)
                    ...
                    .HasConstraintName("FK__QRTZ_CRON_TRIGGE__531856C7");
            });
            ...
            modelBuilder.Entity<QrtzSimpleTriggers>(entity =>
            {
                ...
                entity.HasOne(d => d.QrtzTriggers)
                    ...
                    .HasConstraintName("FK__QRTZ_SIMPLE_TRIG__4D5F7D71");
            });
            ...
            modelBuilder.Entity<QrtzSimpropTriggers>(entity =>
            {
                ...
                entity.HasOne(d => d.QrtzTriggers)
                    ...
                    .HasConstraintName("FK__QRTZ_SIMPROP_TRI__503BEA1C");
            });
            ...
            modelBuilder.Entity<QrtzTriggers>(entity =>
            {
                ...
                entity.HasOne(d => d.QrtzJobDetails)
                    ...
                    .HasConstraintName("FK__QRTZ_TRIGGERS__4A8310C6");
            });
