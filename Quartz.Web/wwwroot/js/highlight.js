!function (e) {
    ...
    function o(e, a, n) {
        ...
        for (var l = 0, u = "", d = []; e.length || a.length;) {
            var b = i();
            if (u += t(n.substr(l, b[0].offset - l)),
                l = b[0].offset,
                b == e) {
                d.reverse().forEach(c);
                do
    ...
    function u(e, r, n, i) {
            ...
            if (n) {
                ...
                do
                    x.cN && (M += "</span>"),
                        B += x.r,
                        x = x.parent;
                while (x != n.parent); return i.eE && (M += t(r)),
                    E = "",
                    n.starts && h(n.starts, ""),
                    i.rE ? 0 : r.length
            }
        ...
        try {
            ...
            if (-1 != q.message.indexOf("Illegal"))
                return {
                    r: 0,
                    value: t(r)
                };
